...
public:
	...
	struct FName                                   Tag;                                               // 0x0028(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(alignof(BTDecorator_BlueprintBase_ReceiveConditionCheck) == 0x000008, "Wrong alignment on BTDecorator_BlueprintBase_ReceiveConditionCheck");
static_assert(sizeof(BTDecorator_BlueprintBase_ReceiveConditionCheck) == 0x000008, "Wrong size on BTDecorator_BlueprintBase_ReceiveConditionCheck");
