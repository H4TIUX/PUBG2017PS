...
static_assert(sizeof(UMovieSceneCapture) == 0x000200, "Wrong size on UMovieSceneCapture");
...
static_assert(sizeof(UAutomatedLevelSequenceCapture) == 0x000200, "Wrong size on UAutomatedLevelSequenceCapture");
...
static_assert(sizeof(ULevelCapture) == 0x000220, "Wrong size on ULevelCapture");
static_assert(offsetof(ULevelCapture, bAutoStartCapture) == 0x000200, "Member 'ULevelCapture::bAutoStartCapture' has a wrong offset!");
static_assert(offsetof(ULevelCapture, PrerequisiteActorId) == 0x00020C, "Member 'ULevelCapture::PrerequisiteActorId' has a wrong offset!");
