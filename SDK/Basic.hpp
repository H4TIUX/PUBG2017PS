...
namespace Offsets
{
	constexpr int32 GObjects          = 0x036E3CD0;
	constexpr int32 AppendString      = 0x007D39D0;
	constexpr int32 GNames            = 0x036DB610;
	constexpr int32 GWorld            = 0x037D8818;
	constexpr int32 ProcessEvent      = 0x0089F6E0;
	constexpr int32 ProcessEventIdx   = 0x00000039;
}
