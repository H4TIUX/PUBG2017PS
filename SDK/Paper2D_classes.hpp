...
static_assert(sizeof(UMaterialExpressionSpriteTextureSampler) == 0x0001D8, "Wrong size on UMaterialExpressionSpriteTextureSampler");
static_assert(offsetof(UMaterialExpressionSpriteTextureSampler, bSampleAdditionalTextures) == 0x0001B8, "Member 'UMaterialExpressionSpriteTextureSampler::bSampleAdditionalTextures' has a wrong offset!");
static_assert(offsetof(UMaterialExpressionSpriteTextureSampler, AdditionalSlotIndex) == 0x0001BC, "Member 'UMaterialExpressionSpriteTextureSampler::AdditionalSlotIndex' has a wrong offset!");
static_assert(offsetof(UMaterialExpressionSpriteTextureSampler, SlotDisplayName) == 0x0001C0, "Member 'UMaterialExpressionSpriteTextureSampler::SlotDisplayName' has a wrong offset!");
...
{
public:
	class UPaperFlipbookComponent*                Sprite;                                            // 0x07C0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(APaperCharacter, Sprite) == 0x0007C0, "Member 'APaperCharacter::Sprite' has a wrong offset!");
...
{
public:
	class UPaperFlipbook*                         SourceFlipbook;                                    // 0x0780(0x0008)(Edit, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     Material;                                          // 0x0788(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         PlayRate;                                          // 0x0790(0x0004)(Edit, Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         bLooping : 1;                                      // 0x0794(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Net, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bReversePlayback : 1;                              // 0x0794(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Net, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bPlaying : 1;                                      // 0x0794(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Net, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_795[0x3];                                      // 0x0795(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         AccumulatedTime;                                   // 0x0798(0x0004)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         CachedFrameIndex;                                  // 0x079C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FLinearColor                           SpriteColor;                                       // 0x07A0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, Protected, NativeAccessSpecifierProtected)
	class UBodySetup*                             CachedBodySetup;                                   // 0x07B0(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	UMulticastDelegateProperty_                   OnFinishedPlaying;                                 // 0x07B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_7C8[0x8];                                      // 0x07C8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPaperFlipbookComponent) == 0x0007D0, "Wrong size on UPaperFlipbookComponent");
static_assert(offsetof(UPaperFlipbookComponent, SourceFlipbook) == 0x000780, "Member 'UPaperFlipbookComponent::SourceFlipbook' has a wrong offset!");
static_assert(offsetof(UPaperFlipbookComponent, Material) == 0x000788, "Member 'UPaperFlipbookComponent::Material' has a wrong offset!");
static_assert(offsetof(UPaperFlipbookComponent, PlayRate) == 0x000790, "Member 'UPaperFlipbookComponent::PlayRate' has a wrong offset!");
static_assert(offsetof(UPaperFlipbookComponent, AccumulatedTime) == 0x000798, "Member 'UPaperFlipbookComponent::AccumulatedTime' has a wrong offset!");
static_assert(offsetof(UPaperFlipbookComponent, CachedFrameIndex) == 0x00079C, "Member 'UPaperFlipbookComponent::CachedFrameIndex' has a wrong offset!");
static_assert(offsetof(UPaperFlipbookComponent, SpriteColor) == 0x0007A0, "Member 'UPaperFlipbookComponent::SpriteColor' has a wrong offset!");
static_assert(offsetof(UPaperFlipbookComponent, CachedBodySetup) == 0x0007B0, "Member 'UPaperFlipbookComponent::CachedBodySetup' has a wrong offset!");
static_assert(offsetof(UPaperFlipbookComponent, OnFinishedPlaying) == 0x0007B8, "Member 'UPaperFlipbookComponent::OnFinishedPlaying' has a wrong offset!");
...
{
public:
	class UPaperFlipbookComponent*                RenderComponent;                                   // 0x03A0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(APaperFlipbookActor) == 0x0003A8, "Wrong size on APaperFlipbookActor");
static_assert(offsetof(APaperFlipbookActor, RenderComponent) == 0x0003A0, "Member 'APaperFlipbookActor::RenderComponent' has a wrong offset!");
...
{
public:
	TArray<class UMaterialInterface*>             InstanceMaterials;                                 // 0x0780(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FSpriteInstanceData>            PerInstanceSpriteData;                             // 0x0790(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UPaperGroupedSpriteComponent) == 0x0007B0, "Wrong size on UPaperGroupedSpriteComponent");
static_assert(offsetof(UPaperGroupedSpriteComponent, InstanceMaterials) == 0x000780, "Member 'UPaperGroupedSpriteComponent::InstanceMaterials' has a wrong offset!");
static_assert(offsetof(UPaperGroupedSpriteComponent, PerInstanceSpriteData) == 0x000790, "Member 'UPaperGroupedSpriteComponent::PerInstanceSpriteData' has a wrong offset!");
...
{
public:
	class UPaperGroupedSpriteComponent*           RenderComponent;                                   // 0x03A0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(APaperGroupedSpriteActor) == 0x0003A8, "Wrong size on APaperGroupedSpriteActor");
static_assert(offsetof(APaperGroupedSpriteActor, RenderComponent) == 0x0003A0, "Member 'APaperGroupedSpriteActor::RenderComponent' has a wrong offset!");
...
{
public:
	class UPaperSprite*                           SourceSprite;                                      // 0x0780(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     MaterialOverride;                                  // 0x0788(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FLinearColor                           SpriteColor;                                       // 0x0790(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UPaperSpriteComponent) == 0x0007A0, "Wrong size on UPaperSpriteComponent");
static_assert(offsetof(UPaperSpriteComponent, SourceSprite) == 0x000780, "Member 'UPaperSpriteComponent::SourceSprite' has a wrong offset!");
static_assert(offsetof(UPaperSpriteComponent, MaterialOverride) == 0x000788, "Member 'UPaperSpriteComponent::MaterialOverride' has a wrong offset!");
static_assert(offsetof(UPaperSpriteComponent, SpriteColor) == 0x000790, "Member 'UPaperSpriteComponent::SpriteColor' has a wrong offset!");
...
{
public:
	class UPaperSpriteComponent*                  RenderComponent;                                   // 0x03A0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(APaperSpriteActor) == 0x0003A8, "Wrong size on APaperSpriteActor");
static_assert(offsetof(APaperSpriteActor, RenderComponent) == 0x0003A0, "Member 'APaperSpriteActor::RenderComponent' has a wrong offset!");
...
{
public:
	class USceneComponent*                        DummyRoot;                                         // 0x03A0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPaperTerrainSplineComponent*           SplineComponent;                                   // 0x03A8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPaperTerrainComponent*                 RenderComponent;                                   // 0x03B0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(APaperTerrainActor) == 0x0003B8, "Wrong size on APaperTerrainActor");
static_assert(offsetof(APaperTerrainActor, DummyRoot) == 0x0003A0, "Member 'APaperTerrainActor::DummyRoot' has a wrong offset!");
static_assert(offsetof(APaperTerrainActor, SplineComponent) == 0x0003A8, "Member 'APaperTerrainActor::SplineComponent' has a wrong offset!");
static_assert(offsetof(APaperTerrainActor, RenderComponent) == 0x0003B0, "Member 'APaperTerrainActor::RenderComponent' has a wrong offset!");
...
{
public:
	class UPaperTerrainMaterial*                  TerrainMaterial;                                   // 0x06C8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bClosedSpline;                                     // 0x06D0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFilledSpline;                                     // 0x06D1(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6D2[0x6];                                      // 0x06D2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UPaperTerrainSplineComponent*           AssociatedSpline;                                  // 0x06D8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         RandomSeed;                                        // 0x06E0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SegmentOverlapAmount;                              // 0x06E4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           TerrainColor;                                      // 0x06E8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, Protected, NativeAccessSpecifierProtected)
	int32                                         ReparamStepsPerSegment;                            // 0x06F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	ESpriteCollisionMode                          SpriteCollisionDomain;                             // 0x06FC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_6FD[0x3];                                      // 0x06FD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CollisionThickness;                                // 0x0700(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_704[0x4];                                      // 0x0704(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UBodySetup*                             CachedBodySetup;                                   // 0x0708(0x0008)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UPaperTerrainComponent) == 0x000720, "Wrong size on UPaperTerrainComponent");
static_assert(offsetof(UPaperTerrainComponent, TerrainMaterial) == 0x0006C8, "Member 'UPaperTerrainComponent::TerrainMaterial' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, bClosedSpline) == 0x0006D0, "Member 'UPaperTerrainComponent::bClosedSpline' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, bFilledSpline) == 0x0006D1, "Member 'UPaperTerrainComponent::bFilledSpline' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, AssociatedSpline) == 0x0006D8, "Member 'UPaperTerrainComponent::AssociatedSpline' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, RandomSeed) == 0x0006E0, "Member 'UPaperTerrainComponent::RandomSeed' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, SegmentOverlapAmount) == 0x0006E4, "Member 'UPaperTerrainComponent::SegmentOverlapAmount' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, TerrainColor) == 0x0006E8, "Member 'UPaperTerrainComponent::TerrainColor' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, ReparamStepsPerSegment) == 0x0006F8, "Member 'UPaperTerrainComponent::ReparamStepsPerSegment' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, SpriteCollisionDomain) == 0x0006FC, "Member 'UPaperTerrainComponent::SpriteCollisionDomain' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, CollisionThickness) == 0x000700, "Member 'UPaperTerrainComponent::CollisionThickness' has a wrong offset!");
static_assert(offsetof(UPaperTerrainComponent, CachedBodySetup) == 0x000708, "Member 'UPaperTerrainComponent::CachedBodySetup' has a wrong offset!");
...
static_assert(sizeof(UPaperTerrainMaterial) == 0x000040, "Wrong size on UPaperTerrainMaterial");
static_assert(offsetof(UPaperTerrainMaterial, Rules) == 0x000028, "Member 'UPaperTerrainMaterial::Rules' has a wrong offset!");
static_assert(offsetof(UPaperTerrainMaterial, InteriorFill) == 0x000038, "Member 'UPaperTerrainMaterial::InteriorFill' has a wrong offset!");
...
public:
	...
	int32                                         WidthInTiles;                                      // 0x0058(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         HeightInTiles;                                     // 0x005C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         AllocatedWidth;                                    // 0x0060(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         AllocatedHeight;                                   // 0x0064(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	int32                                         TileWidth;                                         // 0x0088(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         TileHeight;                                        // 0x008C(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         Margin;                                            // 0x0090(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         Spacing;                                           // 0x0094(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UPaperTileSet) == 0x000098, "Wrong size on UPaperTileSet");
...
static_assert(offsetof(UPaperTileSet, BorderMargin) == 0x000038, "Member 'UPaperTileSet::BorderMargin' has a wrong offset!");
static_assert(offsetof(UPaperTileSet, PerTileSpacing) == 0x000048, "Member 'UPaperTileSet::PerTileSpacing' has a wrong offset!");
static_assert(offsetof(UPaperTileSet, DrawingOffset) == 0x000050, "Member 'UPaperTileSet::DrawingOffset' has a wrong offset!");
static_assert(offsetof(UPaperTileSet, WidthInTiles) == 0x000058, "Member 'UPaperTileSet::WidthInTiles' has a wrong offset!");
static_assert(offsetof(UPaperTileSet, HeightInTiles) == 0x00005C, "Member 'UPaperTileSet::HeightInTiles' has a wrong offset!");
static_assert(offsetof(UPaperTileSet, AllocatedWidth) == 0x000060, "Member 'UPaperTileSet::AllocatedWidth' has a wrong offset!");
static_assert(offsetof(UPaperTileSet, AllocatedHeight) == 0x000064, "Member 'UPaperTileSet::AllocatedHeight' has a wrong offset!");
static_assert(offsetof(UPaperTileSet, PerTileData) == 0x000068, "Member 'UPaperTileSet::PerTileData' has a wrong offset!");
static_assert(offsetof(UPaperTileSet, Terrains) == 0x000078, "Member 'UPaperTileSet::Terrains' has a wrong offset!");
static_assert(offsetof(UPaperTileSet, TileWidth) == 0x000088, "Member 'UPaperTileSet::TileWidth' has a wrong offset!");
static_assert(offsetof(UPaperTileSet, TileHeight) == 0x00008C, "Member 'UPaperTileSet::TileHeight' has a wrong offset!");
static_assert(offsetof(UPaperTileSet, Margin) == 0x000090, "Member 'UPaperTileSet::Margin' has a wrong offset!");
static_assert(offsetof(UPaperTileSet, Spacing) == 0x000094, "Member 'UPaperTileSet::Spacing' has a wrong offset!");
...
static_assert(sizeof(UPaperTileMap) == 0x0000A0, "Wrong size on UPaperTileMap");
...
static_assert(offsetof(UPaperTileMap, Material) == 0x000068, "Member 'UPaperTileMap::Material' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, TileLayers) == 0x000070, "Member 'UPaperTileMap::TileLayers' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, CollisionThickness) == 0x000080, "Member 'UPaperTileMap::CollisionThickness' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, SpriteCollisionDomain) == 0x000084, "Member 'UPaperTileMap::SpriteCollisionDomain' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, ProjectionMode) == 0x000085, "Member 'UPaperTileMap::ProjectionMode' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, HexSideLength) == 0x000088, "Member 'UPaperTileMap::HexSideLength' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, BodySetup) == 0x000090, "Member 'UPaperTileMap::BodySetup' has a wrong offset!");
static_assert(offsetof(UPaperTileMap, LayerNameIndex) == 0x000098, "Member 'UPaperTileMap::LayerNameIndex' has a wrong offset!");
...
{
public:
	class UPaperTileMapComponent*                 RenderComponent;                                   // 0x03A0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(APaperTileMapActor) == 0x0003A8, "Wrong size on APaperTileMapActor");
static_assert(offsetof(APaperTileMapActor, RenderComponent) == 0x0003A0, "Member 'APaperTileMapActor::RenderComponent' has a wrong offset!");
...
{
public:
	int32                                         MapWidth;                                          // 0x0780(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         MapHeight;                                         // 0x0784(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         TileWidth;                                         // 0x0788(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         TileHeight;                                        // 0x078C(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPaperTileSet*                          DefaultLayerTileSet;                               // 0x0790(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMaterialInterface*                     Material;                                          // 0x0798(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UPaperTileLayer*>                TileLayers;                                        // 0x07A0(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPrivate)
	struct FLinearColor                           TileMapColor;                                      // 0x07B0(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	int32                                         UseSingleLayerIndex;                               // 0x07C0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bUseSingleLayer;                                   // 0x07C4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_7C5[0x3];                                      // 0x07C5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UPaperTileMap*                          TileMap;                                           // 0x07C8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPaperTileMapComponent) == 0x0007D0, "Wrong size on UPaperTileMapComponent");
static_assert(offsetof(UPaperTileMapComponent, MapWidth) == 0x000780, "Member 'UPaperTileMapComponent::MapWidth' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, MapHeight) == 0x000784, "Member 'UPaperTileMapComponent::MapHeight' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, TileWidth) == 0x000788, "Member 'UPaperTileMapComponent::TileWidth' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, TileHeight) == 0x00078C, "Member 'UPaperTileMapComponent::TileHeight' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, DefaultLayerTileSet) == 0x000790, "Member 'UPaperTileMapComponent::DefaultLayerTileSet' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, Material) == 0x000798, "Member 'UPaperTileMapComponent::Material' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, TileLayers) == 0x0007A0, "Member 'UPaperTileMapComponent::TileLayers' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, TileMapColor) == 0x0007B0, "Member 'UPaperTileMapComponent::TileMapColor' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, UseSingleLayerIndex) == 0x0007C0, "Member 'UPaperTileMapComponent::UseSingleLayerIndex' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, bUseSingleLayer) == 0x0007C4, "Member 'UPaperTileMapComponent::bUseSingleLayer' has a wrong offset!");
static_assert(offsetof(UPaperTileMapComponent, TileMap) == 0x0007C8, "Member 'UPaperTileMapComponent::TileMap' has a wrong offset!");
