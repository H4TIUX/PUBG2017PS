...
public:
	...
	struct FName                                   EmitterName;                                       // 0x0008(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FName                                   ConstantName;                                      // 0x0010(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(NiagaraFunctionLibrary_SetUpdateScriptConstant) == 0x000008, "Wrong alignment on NiagaraFunctionLibrary_SetUpdateScriptConstant");
static_assert(sizeof(NiagaraFunctionLibrary_SetUpdateScriptConstant) == 0x000028, "Wrong size on NiagaraFunctionLibrary_SetUpdateScriptConstant");
...
static_assert(offsetof(NiagaraFunctionLibrary_SetUpdateScriptConstant, EmitterName) == 0x000008, "Member 'NiagaraFunctionLibrary_SetUpdateScriptConstant::EmitterName' has a wrong offset!");
static_assert(offsetof(NiagaraFunctionLibrary_SetUpdateScriptConstant, ConstantName) == 0x000010, "Member 'NiagaraFunctionLibrary_SetUpdateScriptConstant::ConstantName' has a wrong offset!");
static_assert(offsetof(NiagaraFunctionLibrary_SetUpdateScriptConstant, Value) == 0x000018, "Member 'NiagaraFunctionLibrary_SetUpdateScriptConstant::Value' has a wrong offset!");
