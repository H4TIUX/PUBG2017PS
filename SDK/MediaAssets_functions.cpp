...
// struct FFloatRange                      ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
void UMediaPlayer::GetCaptions(TArray<struct FMediaPlayerOverlay>* OutCaptions) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MediaPlayer", "GetCaptions");

	Params::MediaPlayer_GetCaptions Parms{};
...
void UMediaPlayer::GetSubtitles(TArray<struct FMediaPlayerOverlay>* OutSubtitles) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MediaPlayer", "GetSubtitles");

	Params::MediaPlayer_GetSubtitles Parms{};
...
void UMediaPlayer::GetTexts(TArray<struct FMediaPlayerOverlay>* OutTexts) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MediaPlayer", "GetTexts");

	Params::MediaPlayer_GetTexts Parms{};
