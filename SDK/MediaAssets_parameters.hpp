...
// 0x0010 (0x0010 - 0x0000)
struct MediaPlayer_GetCaptions final
{
public:
	TArray<struct FMediaPlayerOverlay>            OutCaptions;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(MediaPlayer_GetCaptions) == 0x000008, "Wrong alignment on MediaPlayer_GetCaptions");
static_assert(sizeof(MediaPlayer_GetCaptions) == 0x000010, "Wrong size on MediaPlayer_GetCaptions");
static_assert(offsetof(MediaPlayer_GetCaptions, OutCaptions) == 0x000000, "Member 'MediaPlayer_GetCaptions::OutCaptions' has a wrong offset!");
...
// 0x0010 (0x0010 - 0x0000)
struct MediaPlayer_GetSubtitles final
{
public:
	TArray<struct FMediaPlayerOverlay>            OutSubtitles;                                      // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(MediaPlayer_GetSubtitles) == 0x000008, "Wrong alignment on MediaPlayer_GetSubtitles");
static_assert(sizeof(MediaPlayer_GetSubtitles) == 0x000010, "Wrong size on MediaPlayer_GetSubtitles");
static_assert(offsetof(MediaPlayer_GetSubtitles, OutSubtitles) == 0x000000, "Member 'MediaPlayer_GetSubtitles::OutSubtitles' has a wrong offset!");

// Function MediaAssets.MediaPlayer.GetTexts
// 0x0010 (0x0010 - 0x0000)
struct MediaPlayer_GetTexts final
{
public:
	TArray<struct FMediaPlayerOverlay>            OutTexts;                                          // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(MediaPlayer_GetTexts) == 0x000008, "Wrong alignment on MediaPlayer_GetTexts");
static_assert(sizeof(MediaPlayer_GetTexts) == 0x000010, "Wrong size on MediaPlayer_GetTexts");
static_assert(offsetof(MediaPlayer_GetTexts, OutTexts) == 0x000000, "Member 'MediaPlayer_GetTexts::OutTexts' has a wrong offset!");
