...
public:
	...
	struct FVector2D                              Position;                                          // 0x0004(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
struct alignas(0x08) FMediaSubtitle final
{
public:
	uint8                                         Pad_0[0x30];                                       // 0x0000(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMediaSubtitle) == 0x000008, "Wrong alignment on FMediaSubtitle");
static_assert(sizeof(FMediaSubtitle) == 0x000030, "Wrong size on FMediaSubtitle");
