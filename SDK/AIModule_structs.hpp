...
public:
	...
	struct FName                                   Tag;                                               // 0x0028(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct alignas(0x08) FEnvBoolParam_DEPRECATED
{
public:
	bool                                          Value;                                             // 0x0000(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FName                                   ParamName;                                         // 0x0008(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FEnvBoolParam_DEPRECATED) == 0x000008, "Wrong alignment on FEnvBoolParam_DEPRECATED");
static_assert(sizeof(FEnvBoolParam_DEPRECATED) == 0x000010, "Wrong size on FEnvBoolParam_DEPRECATED");
static_assert(offsetof(FEnvBoolParam_DEPRECATED, Value) == 0x000000, "Member 'FEnvBoolParam_DEPRECATED::Value' has a wrong offset!");
static_assert(offsetof(FEnvBoolParam_DEPRECATED, ParamName) == 0x000008, "Member 'FEnvBoolParam_DEPRECATED::ParamName' has a wrong offset!");
...
static_assert(alignof(FEnvBoolParam) == 0x000008, "Wrong alignment on FEnvBoolParam");
static_assert(sizeof(FEnvBoolParam) == 0x000010, "Wrong size on FEnvBoolParam");
...
public:
	...
	uint8                                         Pad_8[0x1D8];                                      // 0x0008(0x01D8)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FEnvQueryInstanceCache) == 0x000010, "Wrong alignment on FEnvQueryInstanceCache");
static_assert(sizeof(FEnvQueryInstanceCache) == 0x0001E0, "Wrong size on FEnvQueryInstanceCache");
...
// 0x0010 (0x0010 - 0x0000)
struct alignas(0x08) FEnvIntParam_DEPRECATED
{
public:
...
static_assert(alignof(FEnvIntParam_DEPRECATED) == 0x000008, "Wrong alignment on FEnvIntParam_DEPRECATED");
static_assert(sizeof(FEnvIntParam_DEPRECATED) == 0x000010, "Wrong size on FEnvIntParam_DEPRECATED");
static_assert(offsetof(FEnvIntParam_DEPRECATED, Value) == 0x000000, "Member 'FEnvIntParam_DEPRECATED::Value' has a wrong offset!");
static_assert(offsetof(FEnvIntParam_DEPRECATED, ParamName) == 0x000008, "Member 'FEnvIntParam_DEPRECATED::ParamName' has a wrong offset!");
...
static_assert(alignof(FEnvIntParam) == 0x000008, "Wrong alignment on FEnvIntParam");
static_assert(sizeof(FEnvIntParam) == 0x000010, "Wrong size on FEnvIntParam");

// ScriptStruct AIModule.EnvFloatParam_DEPRECATED
// 0x0010 (0x0010 - 0x0000)
struct alignas(0x08) FEnvFloatParam_DEPRECATED
{
public:
...
static_assert(alignof(FEnvFloatParam_DEPRECATED) == 0x000008, "Wrong alignment on FEnvFloatParam_DEPRECATED");
static_assert(sizeof(FEnvFloatParam_DEPRECATED) == 0x000010, "Wrong size on FEnvFloatParam_DEPRECATED");
...
static_assert(offsetof(FEnvFloatParam_DEPRECATED, ParamName) == 0x000008, "Member 'FEnvFloatParam_DEPRECATED::ParamName' has a wrong offset!");
...
static_assert(alignof(FEnvFloatParam) == 0x000008, "Wrong alignment on FEnvFloatParam");
static_assert(sizeof(FEnvFloatParam) == 0x000010, "Wrong size on FEnvFloatParam");
