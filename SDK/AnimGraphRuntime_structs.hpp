...
static_assert(sizeof(FAnimNode_CopyPoseFromMesh) == 0x000090, "Wrong size on FAnimNode_CopyPoseFromMesh");
...
static_assert(sizeof(FAnimNode_LayeredBoneBlend) == 0x0000A0, "Wrong size on FAnimNode_LayeredBoneBlend");
...
static_assert(sizeof(FAnimNode_PoseBlendNode) == 0x0000B8, "Wrong size on FAnimNode_PoseBlendNode");
...
public:
	struct FPoseLink                              SourcePose;                                        // 0x00A0(0x0018)(Edit, BlueprintVisible, EditFixedSize, NativeAccessSpecifierPublic)
	struct FBoneReference                         SourceBone;                                        // 0x00B8(0x0010)(Edit, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimationNode_TwoWayBlend) == 0x000008, "Wrong alignment on FAnimationNode_TwoWayBlend");
static_assert(sizeof(FAnimationNode_TwoWayBlend) == 0x000070, "Wrong size on FAnimationNode_TwoWayBlend");
static_assert(offsetof(FAnimationNode_TwoWayBlend, A) == 0x000030, "Member 'FAnimationNode_TwoWayBlend::A' has a wrong offset!");
static_assert(offsetof(FAnimationNode_TwoWayBlend, B) == 0x000048, "Member 'FAnimationNode_TwoWayBlend::B' has a wrong offset!");
static_assert(offsetof(FAnimationNode_TwoWayBlend, Alpha) == 0x000060, "Member 'FAnimationNode_TwoWayBlend::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimationNode_TwoWayBlend, AlphaScaleBias) == 0x000064, "Member 'FAnimationNode_TwoWayBlend::AlphaScaleBias' has a wrong offset!");
...
public:
	...
	struct FName                                   ParameterName;                                     // 0x00B0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FName                                   LookAtSocket;                                      // 0x0090(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	bool                                          bLimitStretch;                                     // 0x0110(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bActorSpaceFakeVel;                                // 0x0124(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FName                                   EffectorSpaceBoneName;                             // 0x00A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FName                                   JointTargetSpaceBoneName;                          // 0x00B0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAnimNode_TwoBoneIK) == 0x000008, "Wrong alignment on FAnimNode_TwoBoneIK");
static_assert(sizeof(FAnimNode_TwoBoneIK) == 0x0000B8, "Wrong size on FAnimNode_TwoBoneIK");
...
static_assert(offsetof(FAnimNode_TwoBoneIK, StretchLimits) == 0x000098, "Member 'FAnimNode_TwoBoneIK::StretchLimits' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorLocationSpace) == 0x0000AC, "Member 'FAnimNode_TwoBoneIK::EffectorLocationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTargetLocationSpace) == 0x0000AD, "Member 'FAnimNode_TwoBoneIK::JointTargetLocationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTargetSpaceBoneName) == 0x0000B0, "Member 'FAnimNode_TwoBoneIK::JointTargetSpaceBoneName' has a wrong offset!");
